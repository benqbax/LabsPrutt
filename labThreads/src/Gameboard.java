...
class Gameboard extends JPanel {
    ...
    private Icon[] icons = {
            new ImageIcon(Gameboard.class.getResource("/recources/rock.gif")),
            new ImageIcon(Gameboard.class.getResource("/recources/paper.gif")),
            new ImageIcon(Gameboard.class.getResource("/recources/scissors.gif"))};
